    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            <ul class="nav navbar-nav navbar-left">
                <li class="active" onclick="loadFile('GravediggerHome.jsp', this); return false;">
                    <a href="">Home</a>
                </li>
     ...
     <!--             <li class="dropdown" onclick="makeActive(this); return false;">
                    ...
                    <ul class="dropdown-menu nav">
                        <li onclick="return false"><a href="">Just for a test</a></li>
                 ...
                 <li class="dropdown" onclick="makeActive(this); return false;">
                      <a href="" class="dropdown-toggle" data-toggle="dropdown" href="">Gravedigger Services<b class="caret"></b></a>
                    <ul class="dropdown-menu nav">
                        <li onclick=""><a href="">View and Modify Records</a></li>
                        <li onclick="loadFile('Suggested_Gravediggers_Page_1.jsp', this);
                        return false;"><a href="">View Suggested Updates</a></li>
                        <li onclick="return false"><a href="">Suggest Updates</a></li>
                        <li onclick="loadFile('testPage.jsp', this);
                        return false;"><a href="">Test page</a></li>
                    </ul>
                </li>
            </ul>
