                        ...
                        <div class="panel-body">
                            ...
                            <div class="box box-info">
                                ...
                                <div class="box-body">
                                    ...
                                    <div class="col-sm-6">
                                        <h2 style="color:#00b1b1;">Mark Jason Harvey </h2></span>
                               ...
                               <!--     <hr style="margin:5px 0 5px 0;">  -->
                                    ...
                                    <div class="tab-content">
                                        <div id="home" class="tab-pane fade in active">
                                            ...
                                            <div class="col-sm-5 col-xs-6 tital " ><strong>First Name:</strong></div><div class="col-sm-5 col-xs-6 "> Mark</div>
                                            <div class="clearfix"></div>
                                            <div class="bot-border"></div>

                                            <div class="col-sm-5 col-xs-6 tital " ><strong>Middle Name:</strong></div><div class="col-sm-7"> Jason</div>
                                            <div class="clearfix"></div>
                                            <div class="bot-border"></div>

                                            <div class="col-sm-5 col-xs-6 tital " ><strong>Last Name:</strong></div><div class="col-sm-7"> Harvey</div>
                                            <div class="clearfix"></div>
                                            <div class="bot-border"></div>
                                        </div>
                                        ...
                                        <div id="menu1" class="tab-pane fade">
                                            <h4>Age details</h4>
                                            <div class="col-sm-5 col-xs-6 tital " ><strong>Age:</strong></div><div class="col-sm-7">83</div>
                                            <div class="clearfix"></div>
                                            <div class="bot-border"></div>

                                            <div class="col-sm-5 col-xs-6 tital " ><strong>Date Of Birth:</strong></div><div class="col-sm-7">11 April 1918</div>
                                            <div class="clearfix"></div>
                                            <div class="bot-border"></div>

                                            <div class="col-sm-5 col-xs-6 tital " ><strong>Date Of Death:</strong></div><div class="col-sm-7">19 January 2001</div>
                                            <div class="clearfix"></div>
                                            <div class="bot-border"></div>

                                            <div class="col-sm-5 col-xs-6 tital " ><strong>Place Of Birth:</strong></div><div class="col-sm-7">Dundalk</div>
                                            <div class="clearfix"></div>
                                            <div class="bot-border"></div>
                                        ...
                                        <div id="menu2" class="tab-pane fade">
                                            <h4>Misc Details</h4>
                                            <div class="col-sm-5 col-xs-6 tital " ><strong>Burial Date:</strong></div><div class="col-sm-7">26 January 2001</div>
                                           <div class="clearfix"></div>
                                           <div class="bot-border"></div>
                                           
                                           <div class="col-sm-5 col-xs-6 tital " ><strong>Martial status:</strong></div><div class="col-sm-7">Married</div>
                                           <div class="clearfix"></div>
                                           <div class="bot-border"></div>
                                           
                                           <div class="col-sm-5 col-xs-6 tital " ><strong>Death Location:</strong></div><div class="col-sm-7">Dundalk</div>
                                           <div class="clearfix"></div>
                                           <div class="bot-border"></div>
                                           
                                           <div class="col-sm-5 col-xs-6 tital " ><strong>Occupation:</strong></div><div class="col-sm-7">Retired</div>
                                           <div class="clearfix"></div>
                                           <div class="bot-border"></div>
       
                                           <div class="col-sm-5 col-xs-6 tital " ><strong>Religion:</strong></div><div class="col-sm-7">Catholic</div>
                                        </div>
