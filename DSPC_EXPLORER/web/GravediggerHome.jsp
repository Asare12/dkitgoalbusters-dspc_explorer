...
<%
    ...
    if (loggedinUser != null && loggedinUser.getUserType() == 1) {
%>
        ...
        <div class="box">
            <div class="row">
                ...
                <h2 class="intro-text text-center">
                    <strong>Gravedigger Services</strong>
                </h2>
                <hr class="tagline-divider">
            </div>
            <div class="row">
                <div class="col-md-3">
                    <ul class="nav">
                        <li onclick="manageUsers(); return false;">
                            <a href >
                                ...
                                <div>
                                    <h4><b>Add/View and Modify Records</b></h4>
                                </div>
                            </a>
                        </li>
                    </ul>
                    ...
                    <div class="col-md-3">
                        ...
                        return false;">
                            <a href >
                                <div>
                                    <img class="img-responsive" src="images/edit.jpg" alt="Edit Icon"/>
                                </div>
                                <div>
                                    <h4><b>View Suggested Updates</b></h4>
                                </div>
                            </a>
                        </li>
                        </ul>
                    ...
                    <div class="col-md-3">
                        ...
                        <li onclick="manageUsers(); return false;">
                            <a href >
                                <div>
                                    <img class="img-responsive" src="images/add-doc.png" alt="Add Icon"/>
                                </div>
                                <div>
                                    <h4><b>Suggest Updates</b></h4>
                                </div>
                            </a>
                        </li>
                    </ul>
